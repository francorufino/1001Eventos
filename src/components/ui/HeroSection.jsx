...
const HeroSection = () => {
  return (
    <section id="herosection" className="relative h-screen">
      ...
      <section
        className={`relative z-10 flex flex-col items-center font-bold justify-center h-full text-white ${gfrib.className}`}
      >
        <p className="text-4xl md:text-8xl  lg:text-8xl text-center font-bold flex flex-wrap text-myellow">
          1001 EVENTOS
        </p>
